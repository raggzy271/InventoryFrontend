...
import { faAddressBook, faBox, faBoxesStacked, faCashRegister, faHome, faMoneyBill1Wave, faTruckLoading, faUser, faUserCircle, faUsers } from "@fortawesome/free-solid-svg-icons";

function Sidebar() {
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style={{ minHeight: '100vh' }}>
            <div className="d-flex flex-column align-items-center">
                <FontAwesomeIcon
                    className="display-6 mb-1"
                    icon={faBoxesStacked}
                />
                <Link to="/track/dashboard" className="link-body-emphasis text-decoration-none display-6">Track Inventory</Link>
            </div>
            <hr />
            ...
            <hr />
            <div> 
                <p className='text-center'>Logged in as <strong>User Name</strong> (user@email.com)</p>
